...
(function () {
  ...
  const SPEED = 12;           // em/с — скорость внутри слова
  const WORD_GAP = 65;        // мс — «перо приподнято» между словами
  const ROW_GAP = 210;        // мс — между строками
  const STANZA_GAP = 360;     // мс — дополнительно перед новой строфой
